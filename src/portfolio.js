...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1gMaAodJTrGWb4JtO09eCAC9NXbHWOfme/view?usp=sharing", // Set to empty to hide the button
...
const skillsSection = {
  ...
  skills: [
    ...
    emoji("⚡ SuiteTalk SOAP/REST Web Services"),
    emoji(
      "⚡ Integration of third party services using REST API"
    )
  ],
